...
class ModerateMessageCommand : public Command{
    public:
        ModerateMessageCommand(ChatRoom* r, string msg, Users* u): Command(r, msg, u) {}
        void execute() override;
};

class SendNotificationCommand:public Command{
    public:
        SendNotificationCommand(ChatRoom* r, string msg, Users* u): Command(r, msg, u) {}
        void execute() override;
};
